...
try {
    ...
    echo "<tr><th class='th_principal'>Id de Máquina</th><th class='th_principal'>Número de Serie</th><th class='th_principal'>Id de Estado</th><th class='th_principal'>Id de Ubicación</th><th class='th_principal'>Modelo</th></tr>";
    foreach ($rows as $row) {
...
try {
    ...
    $rows = $stm->fetchAll(PDO::FETCH_ASSOC); // Obtiene todas las filas como array asociativo
    echo "<table class='tabla_principal'>";
    echo "<th class='th_principal'>Id de Ubicación</th><th class='th_principal'>Cliente</th><th class='th_principal'>Dirección</th>";
    foreach ($rows as $row) {
        echo "<tr class='tr_contenido_principal'>";
        echo "<td class='tabla_principal_td'>" . htmlspecialchars($row['idubicacion']) . "</td>";
